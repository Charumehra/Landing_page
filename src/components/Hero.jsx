...
const Hero = () => {
  ...
  return (
    <div className="relative min-h-screen bg-black flex items-center overflow-hidden">
      ...
      <div className="relative z-10 w-full px-6 md:px-16 py-16 grid lg:grid-cols-2 gap-12 items-center">
      ...
      <div className="absolute bottom-0 left-0 right-0 flex justify-center">
        <div className="relative w-[1400px] h-[300px]">
          ...
          <div className="absolute bottom-0 w-full h-40 rounded-full blur-3xl opacity-60 animate-pulse
          bg-gradient-to-r from-purple-500 via-pink-500 to-blue-500"></div>

          <div className="absolute bottom-10 w-full h-40 rounded-full blur-3xl opacity-50 animate-pulse
          bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-500"></div>

          <div className="absolute bottom-20 w-full h-32 rounded-full blur-3xl opacity-40 animate-pulse
